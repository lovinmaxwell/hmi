<template>
 ...
 <!-- <h1  style="text-align:center" > User Stories </h1> -->
  ...
  <b-img width="300" class="img-circle" alt="Cinque Terre"  src="https://i.pinimg.com/originals/a7/e2/57/a7e2579c60633c543b532c1749716311.gif"></b-img>
  <b-img width="180" style=" position: absolute; right: 625px;" height="350"  src="https://toggl.com/toggl-desktop/images/toggl-man-f7a86f4d8178c67f2cd53ef408f9460e.png"></b-img>
  <b-img width="200" class="img-circle" alt="Cinque Terre" style=" position: absolute; top: 130px;" height="150"  src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/559a6372352761.5be59680ee903.gif"></b-img>
  <b-img width="200" class="img-circle" alt="Cinque Terre" style=" position: absolute; left: 1020px;" height="150"  src="https://i.pinimg.com/originals/fe/ba/99/feba99ebc5c77931d3e790249c554648.gif"></b-img>
  <b-img width="300" class="img-circle" alt="Cinque Terre" style=" position: absolute; right: 80px;" src="https://i.pinimg.com/originals/10/74/4c/10744cec98ad9c67120f8d6134d59b92.gif"></b-img>
...
label="Model User Story : As a 'customer' I want to 'see how many products sold' so that 'I can update my stock details'" label-for="input-lg">
</b-form-group>
    ...
    > 
      ...
      >
       ...
       <b-form-group
        label-cols-sm="3"
        label="Status"
        label-align-sm="right" class="mb-1"
      >
        <b-form-radio-group
          class="pt-2" :options="['Done']"
        ></b-form-radio-group>
      </b-form-group>
    </b-form-group>
  </b-card>
